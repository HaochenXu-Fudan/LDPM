...
## Main part
class GL_Hillclimb_Base(Gradient_Descent_Algo):
...
class GL_Hillclimb(GL_Hillclimb_Base):
    method_label = "GL_Hillclimb"

    def _create_lambda_configs(self):
        self.lambda_mins = [1e-6] * (self.settings.num_experiment_groups)
