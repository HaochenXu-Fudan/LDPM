#!/usr/bin/env python3
"""Run one manuscript synthetic Group Lasso experiment.

The default contract uses p=2400, 40 disjoint groups of size 60,
1600/1600/1600 samples, SNR 2, and the five active groups specified in
``INFORMS-IJOC-Template.tex``.  ``--sparse-group`` remains available for
explicit auxiliary runs; the formal Sparse Group Lasso entrypoint is
``../SGL/experiment.py``.
"""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--p", type=int, default=2400)
