...
class MatrixSparseGroupLassoProblem:
    ...
    The synthetic experiment in :mod:`synthetic` passes
    a configurable number of ``group_l2`` regularizers and no L1 regularizer.
    The generic L1 code paths only keep this primitive reusable; they are not
    part of the reported Group/Sparse-Group Lasso experiment.
    """
